...
* Rethink the completely vertical layout: consider reorderable views or tabs for sections such as the activity table and model breakdown, so users can arrange the UI around what they want to see. This is an exploratory idea for a broader UI rethink, not a settled design.
